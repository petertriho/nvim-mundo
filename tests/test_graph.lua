...
test.it("should generate graph with multiple nodes and vertical lines", function()
    ...
    test.assert.equals(result[1][1], "w", "first node should be write state (desc order)")
    test.assert.equals(result[2][1], "|", "should have vertical line between nodes")
    test.assert.equals(result[3][1], "@", "second node should be current (desc order)")
end)
...
test.it("should mark different node types correctly", function()
    ...
    test.assert.equals(node_markers[1], "w", "write node should be 'w' (desc order)")
    test.assert.equals(node_markers[2], "@", "current node should be '@' (desc order)")
    test.assert.equals(node_markers[3], "o", "regular node should be 'o' (desc order)")
end)
